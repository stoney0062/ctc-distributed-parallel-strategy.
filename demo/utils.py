...
#def input_coding(string):
#    outputs = []
#    for i in string:
#        if i == "'":
#          outputs.append( np.array([1]*27).astype(np.float32))
#          continue
#        onechar = []
#        for j in range(27):
#            if j==(ord(i)-96):
#                onechar.append(int(1))
#            else:
#                onechar.append(int(0))      
#        outputs.append(np.array(onechar).astype(np.float32))
#    return np.asarray(outputs)
#
#
#def input_decode(outputs):
#    string = ""
#    for item in outputs:
#        if item[0] == item[1] and item[0] == 1.0:
#            string += "'"
#            continue
#        for i in range(27):
#            if item[i] > 0:
